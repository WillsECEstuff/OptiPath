/*****************************************************************//**
 * @file   ordermenu.cpp
 * @brief  This file contains the definitions for ordermenu.h
 * @date   November 2020
 * @author W Truong
 *********************************************************************/
...
void ordermenu::onCompletedOrder() {
    int orderIdx = ordercbox->currentIndex();
    orderList[orderIdx-1].orderCompleted();

    std::cout << std::to_string(orderList[orderIdx-1].getOrderStatus()) << std::endl;
    show();
}
...
void ordermenu::handleRouteButton() {
    ...
    connect (routeMap, SIGNAL(COB()), this, SLOT(onCompletedOrder()));
    ...
    if (orderIdx < 1) {
        ...
        std::cout << std::to_string(o.getOrderStatus()) << std::endl;
        ...
        std::cout << "Lower bound is: " << mst.findLowerBound() << std::endl;
        ...
        routeMap->loadOrderStatus(o.getOrderStatus());
